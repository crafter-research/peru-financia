  ...
  return (
    <html lang="es">
      <body className={`${geistSans.variable} ${geistMono.variable} antialiased`}>
        <div className="sticky top-0 z-40 border-b border-[#1f1f1f] bg-[#0a0a0a]/90 backdrop-blur-sm px-4 sm:px-6 py-3">
          <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
            <div className="flex items-center gap-3 sm:gap-6 shrink-0">
              <a href="/" className="text-sm font-semibold tracking-tight">
                peru<span className="text-[#c084fc]">-financia</span>
              </a>
              <Link href="/donante" className="text-xs sm:text-sm text-[#888] hover:text-foreground transition-colors">
                Donantes
              </Link>
            </div>
            <Suspense>
        ...
        {children}
        <Analytics />
        <footer className="border-t border-[#1f1f1f] px-4 sm:px-6 py-6 mt-12">
          <div className="max-w-7xl mx-auto flex flex-col gap-3 text-xs text-[#888]">
